...
GITHUB_REPO = "Norkezz/AegisLicense"
GITHUB_API = f"https://api.github.com/repos/{GITHUB_REPO}/releases/latest"
USER_AGENT = f"AegisNET/{APP_VERSION}"
...
class UpdateChecker(QThread):
    ...
    def run(self) -> None:
        # Проверка обновлений отключена — всегда сообщаем что обновлений нет
